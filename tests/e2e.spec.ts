...
import { runCommonTest } from './common';
import { runMainTest } from './main/iotype.spec';
import type { TestFixtures, UnigenTestType } from './type';

process.env.PLAYWRIGHT_TEST = 'true';

// Declare the types of your fixtures.

const test: UnigenTestType = base.extend<TestFixtures>({
  electronApp: [async ({ launchOptions }, use) => {
     ...
     */
    let executablePattern = 'dist/*/unigen{,.*}';
    if (platform === 'darwin') {
      executablePattern += '/Contents/*/unigen';
    }
